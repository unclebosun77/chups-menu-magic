...
export const personalizedRestaurants = [
  {
    ...
    priceLevel: "££–£££",
    matchScore: 92,
    aiReason: "This fits because you enjoy bold, West African flavours.",
    isOpen: true,
    distance: "1.2 km",
    rating: 4.8,
  ...
  },
  {
    ...
    priceLevel: "£££",
    matchScore: 89,
    aiReason: "This fits because you gravitate towards refined Italian spots.",
    isOpen: true,
    distance: "0.8 km",
    rating: 4.9,
  ...
  },
  {
    ...
    priceLevel: "££–£££",
    matchScore: 85,
    aiReason: "This fits because you keep coming back to Thai and Asian food.",
    isOpen: true,
    distance: "1.5 km",
    rating: 4.7,
