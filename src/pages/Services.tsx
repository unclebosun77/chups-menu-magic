  ...
  const experienceCategories = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Farm-to-Table Tours", icon: Map, emoji: "🚜", description: "Visit farms & see food sources" },
        { name: "Family Cooking", icon: Users, emoji: "👨‍👩‍👧‍👦", description: "Fun culinary activities for all ages" },
      ],
    },
    {
      id: "wellness",
      ...
      items: [
        ...
        { name: "Detox Programs", icon: Sparkles, emoji: "💫", description: "Cleanse & rejuvenate your body" },
        { name: "Fitness Meals", icon: Award, emoji: "💪", description: "High-protein post-workout nutrition" },
      ],
    },
    {
      id: "celebrations",
