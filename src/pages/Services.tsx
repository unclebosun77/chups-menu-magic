import { 
  Sparkles, Compass, Heart, Settings, UtensilsCrossed,
...
const Services = () => {
  ...
  const curatedExperiences = [
    { icon: Heart, title: "Date Night Spots", description: "Romantic restaurants perfect for two" },
    { icon: Users, title: "Group-Friendly", description: "Great for parties and gatherings" },
    { icon: TrendingUp, title: "Trending This Week", description: "What's hot right now" },
    { icon: Globe, title: "Around The World", description: "Explore global cuisines" },
  ];
          ...
          return (
            ...
            >
              <div className="flex items-start gap-4">
                <div className="p-3 rounded-xl bg-purple/10 group-hover:scale-110 transition-transform duration-300">
      ...
      <div className="px-5 mt-8 pb-24">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="text-sm font-medium text-purple hover:text-purple/80 flex items-center gap-1 transition-colors"
          >
            View All
