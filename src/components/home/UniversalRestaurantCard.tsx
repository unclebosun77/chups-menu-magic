...
const UniversalRestaurantCard = ({ restaurant, variant = "default" }: UniversalRestaurantCardProps) => {
  ...
  return (
    <Card
      className="flex-shrink-0 w-[140px] overflow-hidden hover:shadow-md transition-all cursor-pointer group bg-card rounded-2xl border border-border/50 shadow-sm"
