...
const PersonalizedRestaurantCard = ({ restaurant }: PersonalizedRestaurantCardProps) => {
  ...
  return (
    <Card
      className="flex-shrink-0 w-60 overflow-hidden hover:shadow-md transition-all cursor-pointer group bg-card rounded-2xl border border-border/50 shadow-sm"
